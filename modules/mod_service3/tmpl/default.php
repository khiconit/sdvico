...
?><div class="wpb_wrapper"> <!--  -->
                    <div class='wpb_content_element image-heading header-brush section-header'><h3 class=''><img src='<?php echo JURI::base();?>templates/sdvico/wp-content/themes/makeclean/images/icon/sep-icon.png' alt='sep-icon'>INDUSTRIES WE SERVE</h3></div>
            ...
            <div class="wpb_text_column wpb_content_element ">
                <div class="wpb_wrapper">
                    <p><img class="alignnone wp-image-62 size-full" src="<?php echo JURI::base();?>templates/sdvico/wp-content/uploads/sites/29/2015/05/airline.png" alt="Icon" width="25" height="25" />Airports &amp; Airlines</p>
